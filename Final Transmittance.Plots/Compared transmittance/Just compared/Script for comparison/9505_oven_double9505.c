...
void graphs(){
  ...
  string filename [6]={"604_9505_1_0.CSV","604_9505_1_1.CSV","604_9505_1_2.CSV","604_9505_oven_double_1_0.CSV","604_9505_oven_double_1_1.CSV","604_9505_oven_double_1_2.CSV"};
  ...
  */
  ...
  legend->AddEntry(graphs3,"604_9505","l");
  legend->AddEntry(graphs4,"604_9505_oven_double","l");
  legend->Draw("AP");
  /*
