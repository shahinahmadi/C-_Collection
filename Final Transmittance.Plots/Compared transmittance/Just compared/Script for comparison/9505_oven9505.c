...
void graphs(){
  ...
  string filename [6]={"604_9505_1_0.CSV","604_9505_1_1.CSV","604_9505_1_2.CSV","604_9505_oven_1_0.CSV","604_9505_oven_1_1.CSV","604_9505_oven_1_2.CSV"};
  ...
  */
  ...
  legend->AddEntry(graphs4,"604_9505_oven","l");
  legend->Draw("AP");
  /*
