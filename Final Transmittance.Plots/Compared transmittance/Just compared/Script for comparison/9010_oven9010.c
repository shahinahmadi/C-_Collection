...
void graphs(){
  ...
  string filename [6]={"604_9010_2_0.CSV","604_9010_2_1.CSV","604_9010_2_2.CSV","604_9010_oven_2_0.CSV","604_9010_oven_2_1.CSV","604_9010_oven_2_2.CSV"};
  ...
  */
  ...
  legend->AddEntry(graphs3,"604_9010","l");
  legend->AddEntry(graphs4,"604_9010_oven","l");
  legend->Draw("AP");
  /*
